...
def two_circles():
    ...
    circle1=rg.Circle(rg.Point(100, 200), 25)
...
def circle_and_rectangle():
    ...
    # -------------------------------------------------------------------------
    window=rg.RoseWindow(400,400)
    circle=rg.Circle(rg.Point(100, 200), 40)
    circle.fill_color='blue'
    circle.attach_to(window)
    rectangle=rg.Rectangle(rg.Point(240, 150), rg.Point(360, 250))
...
def lines():
    ...
    print("    Midpoint X coordinate:", line1.get_midpoint().x)
    print("    Midpoint Y coordinate:", line1.get_midpoint().x)
